...
package com.bv.netpop.mobileQR.kotlin
...
import com.bv.netpop.mobileQR.CameraSource
import com.bv.netpop.mobileQR.CameraSourcePreview
import com.bv.netpop.mobileQR.GraphicOverlay
import com.bv.netpop.mobileQR.R
import com.bv.netpop.mobileQR.kotlin.barcodescanner.BarcodeActivityAdapter
import com.bv.netpop.mobileQR.kotlin.barcodescanner.BarcodeScannerProcessor
import com.bv.netpop.mobileQR.kotlin.facedetector.FaceDetectorProcessor
import com.bv.netpop.mobileQR.kotlin.labeldetector.LabelDetectorProcessor
import com.bv.netpop.mobileQR.kotlin.objectdetector.ObjectDetectorProcessor
import com.bv.netpop.mobileQR.kotlin.posedetector.PoseDetectorProcessor
import com.bv.netpop.mobileQR.kotlin.segmenter.SegmenterProcessor
import com.bv.netpop.mobileQR.kotlin.textdetector.TextRecognitionProcessor
import com.bv.netpop.mobileQR.preference.PreferenceUtils
import com.bv.netpop.mobileQR.preference.SettingsActivity
import com.bv.netpop.mobileQR.preference.SettingsActivity.LaunchSource
...
class LivePreviewActivity :
  ...
  var barcodes: ArrayList<String> = ArrayList<String>(0)
  lateinit var projectAdapter: BarcodeActivityAdapter
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    val rvBarcodes = findViewById<View>(R.id.BCRecyclerView) as RecyclerView
    projectAdapter = BarcodeActivityAdapter(barcodes)
    rvBarcodes.adapter = projectAdapter
    rvBarcodes.layoutManager = LinearLayoutManager(this)
    ...
    try {
      when (model) {
        ...
        BARCODE_SCANNING -> {
          ...
          cameraSource!!.setMachineLearningFrameProcessor(BarcodeScannerProcessor(this,barcodes,projectAdapter))
        }
        IMAGE_LABELING -> {
